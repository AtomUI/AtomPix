...
public sealed class CorePublicApiContractTests
{
    ...
    public void Core_public_type_surface_is_explicitly_owned()
    {
        ...
        var expected = new[]
        {
            ...
            "AtomPix.Core.Compression.ResizeMode",
            "AtomPix.Core.Compression.ResizePolicy",
            ...
            "AtomPix.Core.Licensing.BillingCycle",
            "AtomPix.Core.Licensing.DefaultFeatureAccessPolicy",
            "AtomPix.Core.Licensing.FeatureAccessBlockReason",
            "AtomPix.Core.Licensing.FeatureAccessDecision",
            "AtomPix.Core.Licensing.FeatureId",
            "AtomPix.Core.Licensing.IFeatureAccessPolicy",
            "AtomPix.Core.Licensing.SubscriptionState",
            "AtomPix.Core.Licensing.SubscriptionStatus",
            ...
            "AtomPix.Core.Ports.ISubscriptionStore",
